...
"es6-impl", "es3");
var $jscomp$this = this; (function(e, r) {
...
function() {
    ...
    function r(a, c) {
        for (var d = a.length,
        b = 2 <= arguments.length ? arguments[1] : void 0, f = [], n = 0; n < d; n++) if (n in a) {
            var k = a[n];
    ...
    function q(a) {
        ...
        function k(a) {
            ...
            f("run");
            if (q > n && q < k) b(q);
            else if (q <= n && 0 !== r && (b(0), x && e()), q >= k && r !== k || !k) b(k),
            x || e();
            f("update");
