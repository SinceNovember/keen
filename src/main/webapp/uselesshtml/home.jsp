...
<head>
    ...
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/static/images/Logo_40.png" type="image/x-icon">
    <!--Layui-->
    ...
    <nav class="blog-nav layui-header">
        <div class="blog-container">
            ...
            <a href="javascript:;" class="blog-user layui-hide">
                <img src="${pageContext.request.contextPath}/static/images/Absolutely.jpg" alt="Absolutely" title="Absolutely" />
            </a>
            <!-- 不落阁 -->
              ...
              <c:forEach items="${blogList}" var="blog">
                    <div class="article shadow">
                        <div class="article-left">
                            <img src="${pageContext.request.contextPath}/static/images/cover/201703181909057125.jpg" alt="基于laypage的layui扩展模块（pagesize.js）！" />
                        </div>
                        <div class="article-right">
                            <div class="article-title">
                                <a href="detail.html">${blog.title}</a>
                            </div>
                        ...
                        <div class="article-footer">
                            <span><i class="fa fa-clock-o"></i>&nbsp;&nbsp;${blog.releaseDateStr }</span>
