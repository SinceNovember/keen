	...
	<h2 class="post-title" itemprop="name headline">categories</h2>
      ...
      <div class="category-all-page">
        <div class="category-all-title">
            目前共计 ${blogTypeNum } 个分类
        </div>
        <div class="category-all">
          <ul class="category-list">
          <c:forEach var="blogType" items="${blogTypeList }">
          <li class="category-list-item"><a class="category-list-link" href="${pageContext.request.contextPath }/blog/categories/${blogType.id}">${blogType.typeName}</a><span class="category-list-count">${blogType.blogCount }</span></li>
          </c:forEach>
        </div>
      </div>
  </div>
