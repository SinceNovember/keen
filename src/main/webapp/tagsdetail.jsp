...
<jsp:include page="common/head.jsp"></jsp:include>
  ...
  <section id="posts" class="posts-collapse">
    ...
    <c:forEach var="tagName" items="${ListBytag}">
  <article class="post post-type-normal" itemscope="" itemtype="http://schema.org/Article" style="opacity: 1; display: block; transform: translateY(0px);">
    <header class="post-header">
      <h2 class="post-title">
            <a class="post-title-link" href="${pageContext.request.contextPath }/blog/articles/${tagName.id}" itemprop="url">
                <span itemprop="name">${tagName.title }</span>
            </a>
      </h2>
      <div class="post-meta">
        <time class="post-time" itemprop="dateCreated" datetime="2015-05-19T00:00:00+08:00" content="2015-05-19">
          ${tagName.releaseDateStr }
        </time>
      </div>
    </header>
  </article>
