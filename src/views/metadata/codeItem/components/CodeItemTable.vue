<template>
    <div class="table-main">
        <el-table ref="table" :data="list" tooltip-effect="dark" style="width: 100%" v-loading="loading"
            ...
            <el-table-column prop="itemText" label="代码项名" width="180" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="itemValue" label="代码项值" width="180" show-overflow-tooltip>
            </el-table-column>
        ...
        <!-- <el-dialog title="提示" :visible.sync="infoDialog" width="760px" top="50px" append-to-body>
            <div slot="title">
        ...
        <keen-dialog :visible="infoDialog" title="代码项详情" @cancel="infoDialog = false" :showSave="false" :appendBody="true">
            <code-item-info :dataInfo="dataInfo"></code-item-info>
        </keen-dialog>
    </div>
</template>
