<template>
    <div class="table-main">
        <el-table ref="table" :data="list" tooltip-effect="dark" style="width: 100%" v-loading="loading"
            ...
            <el-table-column prop="codeName" label="代码名称" width="320" show-overflow-tooltip>
            </el-table-column>
                        ...
                        <el-dropdown trigger="click" @command="handleCommand">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                <el-dropdown-item :command="'detail_' + row.id"> <i class="fs-5 bi bi-eye-fill"></i>
                                    详情</el-dropdown-item>
                                <el-dropdown-item :command="'configItem_' + row.id"><i class="fs-5 bi bi-grid"></i>
        ...
        <keen-dialog :visible.sync="infoDialog" title="代码详情" @cancel="infoDialog = false" :showSave="false">
            <code-main-info :dataInfo="dataInfo"></code-main-info>
        </keen-dialog>


        <!-- <el-dialog title="提示" :visible.sync="configItemDialog" width="1200px" top="50px">
            <div slot="title">
                <img alt="Logo" src="@/assets/media/logos/default-small.svg">
                <span class="header-title">
                    配置代码项
            ...
            <code-item v-if="configItemDialog" ref="configItem" :codeId="codeId" @cancel="cancelConfig"></code-item>
        </el-dialog> -->

        <keen-dialog :visible.sync="configItemDialog" title="配置代码项" :width="1200" @cancel="infoDialog = false"
            :showSave="false" :showClose="false">
            <code-item v-if="configItemDialog" ref="configItem" :codeId="codeId" @cancel="cancelConfig"></code-item>
        </keen-dialog>
    </div>
</template>
