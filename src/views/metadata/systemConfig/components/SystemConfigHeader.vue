<template>
    <div class="progress-vertical">
        <div class="progress-vertical gap-2">
            <el-input v-model="params.configName" style="width: 200px;" small prefix-icon="el-icon-search"
                @change="search" placeholder="请输入参数名称"></el-input>
        ...
        <!-- <el-dialog title="提示" :visible.sync="dialog" width="680px" top="50px">
            <div slot="title">
            ...
            <system-config-add ref="add" :systemConfigInfo="systemConfigInfo" @search="refreshTable"
                @cancel="cancel"></system-config-add>
        ...
        <keen-dialog :visible.sync="dialog" title="添加系统参数" @cancel="dialog = false" @save="save">
            <system-config-add ref="add" :systemConfigInfo="systemConfigInfo" @search="refreshTable"
                @cancel="cancel"></system-config-add>
        </keen-dialog>
    </div>
