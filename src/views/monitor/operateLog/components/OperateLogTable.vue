<template>
    <div class="table-main">
        <el-table ref="table" :data="list" tooltip-effect="dark" style="width: 100%" v-loading="loading"
            ...
            <el-table-column prop="nickname" label="操作人" width="140" show-overflow-tooltip>
            </el-table-column>
        ...
        <keen-dialog :visible.sync="infoDialog" title="操作日志详情" @cancel="infoDialog = false" :showSave="false">
            <operate-log-info :dataInfo="dataInfo"></operate-log-info>
        </keen-dialog>
    </div>
</template>
