<template>
    <div class="progress-vertical">
        <div class="progress-vertical gap-2">
            <el-input v-model="params.title" style="width: 200px;" small prefix-icon="el-icon-search" @change="search"
        ...
        <keen-dialog :visible.sync="dialog" title="添加菜单"  @cancel="dialog = false" @save="save">
            <menu-add ref="add" :menuInfo="menuInfo" @search="refreshTable" @cancel="cancel"></menu-add>
        </keen-dialog>
