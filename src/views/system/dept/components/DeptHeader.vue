<template>
    <div class="progress-vertical">
        <div class="progress-vertical gap-2">
            <el-input v-model="params.deptName" style="width: 200px;" small prefix-icon="el-icon-search"
                @change="search" placeholder="请输入部门名称"></el-input>
        ...
        <keen-dialog :visible.sync="dialog" title="添加部门"  @cancel="dialog = false" @save="save">
            <dept-add ref="add" :deptInfo="deptInfo" @search="refreshTable" @cancel="cancel"></dept-add>
        </keen-dialog>
