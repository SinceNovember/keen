<template>
    <div class="table-main">
        <el-table ref="table" :data="list" tooltip-effect="dark" style="width: 100%" v-loading="loading" row-key="id"
            ...
            <el-table-column prop="deptShortName" label="部门简称" show-overflow-tooltip>
            </el-table-column>
            <el-table-column label="部门人员" width="260" show-overflow-tooltip>
                <template slot-scope="{row}">
                    <avatar-list :list="row.users"> </avatar-list>
                </template>

            </el-table-column>
            <el-table-column prop="orderNum" label="排序" width="120" sortable align="center" show-overflow-tooltip>
            </el-table-column>
        ...
        <keen-dialog :visible.sync="infoDialog" title="部门详情" @cancel="infoDialog = false" :showSave="false">
