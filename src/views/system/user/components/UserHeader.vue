<template>
    <div class="progress-vertical">
        <div class="progress-vertical gap-2">
            <el-input v-model="params.nickname" style="width: 200px;" small prefix-icon="el-icon-search"
                @change="search" placeholder="请输入用户名称"></el-input>
        ...
        <keen-dialog :visible.sync="dialog" title="添加用户" :width="760" @cancel="dialog = false" @save="save">
            <user-add ref="add" :userInfo="userInfo" @search="refreshTable" @cancel="cancel"></user-add>
        </keen-dialog>
