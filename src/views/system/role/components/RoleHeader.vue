<template>
    <div class="progress-vertical">
        <div class="progress-vertical gap-2">
            <el-input v-model="params.roleName" style="width: 200px;" small prefix-icon="el-icon-search"
                @change="search" placeholder="请输入角色名称"></el-input>
        ...
        <keen-dialog :visible.sync="dialog" title="添加角色" @cancel="dialog = false" @save="save">
            <role-add ref="add" :roleInfo="roleInfo" @search="refreshTable" @cancel="dialog = false"></role-add>
        </keen-dialog>
    </div>
</template>
<script>
