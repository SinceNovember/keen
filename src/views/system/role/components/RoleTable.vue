<template>
    <div class="table-main">
        <el-table ref="table" :data="list" tooltip-effect="dark" style="width: 100%" v-loading="loading"
            ...
            <el-table-column prop="roleTag" label="角色标志" width="160" show-overflow-tooltip>
            </el-table-column>
        ...
        <keen-dialog title="角色详情" :visible.sync="infoDialog" :showSave="false" @cancel="infoDialog = false">
            <role-info :dataInfo="dataInfo" @cancel="infoDialog = false"></role-info>
        </keen-dialog>
    </div>
</template>
<script>
