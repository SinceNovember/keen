...
export const fetchUserLoginLogs = params => { return axios.get('/api/auth/loginLog', { params: params }); };

export const fetchUserOperateLogs = params => { return axios.get('/api/auth/operateLog', { params: params }); };
...
export const updateUsername = params => { return axios.put('/api/auth/username', params); };

export const updatePassword = params => { return axios.put('/api/auth/password', params); };
